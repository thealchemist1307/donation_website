...
const SignUpButton = () => {
  ...
  return<div>  <button onClick={onSubmit}  className="Reciever">Sign Up</button> </div>
}
class RecieverLogin extends React.Component {
  ...
  render() {
    return (
        ...
        <div data-layer="68ffe7aa-e32c-4b43-aa63-d4f8e43aad56" className="login2d0827ef"> Reciever Login</div>
